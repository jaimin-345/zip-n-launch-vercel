...
import { ArrowLeft, ArrowRight, Building2, Users, FileText, Eye, CheckCircle } from 'lucide-react';
...
import { Step3_GenerateContracts } from '@/components/contract-management/Step3_GenerateContracts';
import { Step4_Preview } from '@/components/contract-management/Step4_Preview';
...
const steps = [
  ...
  { id: 5, name: 'Close Out', icon: CheckCircle },
];
        ...
        return (
          <React.Fragment key={step.id}>
            <button
              ...
              className={cn(
                "flex flex-col items-center gap-2 p-2 rounded-lg transition-all min-w-[100px]",
...
const ContractManagementPage = () => {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 3:
        return <Step3_GenerateContracts formData={formData} setFormData={setFormData} />;
      case 4:
        return <Step4_Preview formData={formData} setFormData={setFormData} />;
      case 5:
        return <Step5_CloseOut formData={formData} setFormData={setFormData} />;
      default:
        return null;
    }
  };
            ...
            <CardContent className="pt-6">
              ...
              <div className="flex justify-between mt-8 pt-6 border-t">
                ...
                {currentStep < 5 ? (
                  ...
                  <Button onClick={() => toast({ title: 'Contracts Finalized!', description: 'All contracts have been processed successfully.' })}>
