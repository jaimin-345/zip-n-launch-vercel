...
export const Step7_Review = ({ formData, pricing, handlePurchase }) => {
  return (
    <motion.div key="step7-review" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -50 }}>
      <CardHeader>
        <CardTitle>Step 7: Review & Purchase</CardTitle>
